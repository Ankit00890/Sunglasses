  ...
  return (
    <section className="px-8 py-24 md:py-32 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div className="relative group cursor-pointer overflow-hidden bg-zinc-900 aspect-square md:aspect-auto md:h-[600px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="group cursor-pointer">
          ...
          <div className="flex justify-between items-start px-2">
            <div>
              <h3 className="font-black text-xl italic uppercase tracking-tighter">Vintage Tortoise</h3>
